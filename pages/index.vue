					...
					>
						...
						>
							...
							>
								...
								>
									<div
										class="slider-heading mb-5 text-5xl font-bold"
									>
										{{ heroSlide['title'] }}
									</div>
									<span
								...
								<div class="info-bottom">
									<div
										class="btn-wrapper btn-wrapper-lg btn-wrapper-white"
									>
										<Button
											btnWrapperSize="lg"
											btnWrapperType="white"
											v-if="
												heroSlide['button']['visible']
											"
											:btnHref="heroSlide['button']['to']"
											:btnText="
												heroSlide['button']['title']
											"
										/>
									</div>
								</div>
				...
				<div class="overflow-hidden">
					<div class="container">
						<client-only>
							...
							>
								<div
									v-for="(model, idx) in filterModels"
									v-show="model['isShow']"
									:key="idx"
								...
								>
									<div class="top mb-[10px]">
										...
										<div class="model-row">
											<div class="d-flex">
												<span
													class="mr-[10px] price-sm text-base"
													>от
													{{ model['price'] }} ₸</span
												>
											</div>
								...
								<div class="offers-card w-full">
									...
									<div class="p-5">
										<div class="flex flex-col">
											...
											<p
												class="mt-2.5 underlined-black leading-5"
											>
												{{ offerCar['text'] }}
											</p>
										</div>
			...
			heroSlides: [
				{
					title: 'K5',
					text: 'K5 Text',
					image: 'https://kia-altyncar.kz/wp-content/uploads/2022/06/k5-nash.jpg',
					side: 'left',
					button: {
						visible: true,
						title: 'Подробнее',
			...
			models: [
				{
					...
					to: '#',
					isShow: true,
					image: 'https://kia-altyncar.kz/wp-content/webp-express/webp-images/uploads/2021/03/picanto-2-768x375.png.webp',
					sale: false,
				},
				{
					name: 'Rio',
